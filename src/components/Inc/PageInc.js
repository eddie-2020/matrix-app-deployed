...
import CompanyTop from '../TopInc';
import CompanyBanner from '../Finance/Banner';
import FinanceHeading from '../Finance/HeadOfFinance';
import FinanceSection from './FinanceIncSec';

const CompanyPage = function myCompany({ info, symbol }) {
